 ...
 */
public class LabeledDatasetPartitionDataBuilderOnHeap2<K, V, C extends Serializable>
    implements PartitionDataBuilder<K, V, C, LabeledVectorSet2<Double, DBSCANVector>> {
    /** */
     ...
     */
    public LabeledDatasetPartitionDataBuilderOnHeap2(IgniteBiFunction<K, V, Vector> xExtractor,
    ...
    /** {@inheritDoc} */
    @Override public LabeledVectorSet2<Double, DBSCANVector> build(
        ...
        return new LabeledVectorSet2<Double, DBSCANVector>(x, y);
    }
}
