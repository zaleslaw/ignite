...
package org.apache.ignite.examples.ml.inference.exportimport.notworking;
 ...
 */
public class ANNClassificationExample2 {
    /**
     * Run example.
     */
    public static void main(String[] args) {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            try {
                ...
                ANNClassificationModel knnMdl = (ANNClassificationModel) trainer.fit(
                    ignite,
                    dataCache,
                ...
                Path jsonMdlPath = Paths.get("C:\\ignite\\ann.json");
                knnMdl.toJSON(jsonMdlPath); // TODO: write to the root in tmp directory

                ANNClassificationModel jsonMdl = new ANNClassificationModel().fromJSON(jsonMdlPath);
