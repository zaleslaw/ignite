    ...
    public static void main(String[] args) throws IOException {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            try {
                ...
                SVMLinearClassificationModel pmmlMdl = new SVMLinearClassificationModel().load(pmmlMdlPath, ModelFormat.PMML);
                ...
                SVMLinearClassificationModel jsonMdl = new SVMLinearClassificationModel().load(jsonMdlPath, ModelFormat.JSON);
