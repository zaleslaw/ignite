 ...
 */
public class GmmClusterizationExample2 {
    /**
     * Runs example.
     *
    ...
    public static void main(String[] args) {
        ...
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            try {
                ...
                Path jsonMdlPath = Paths.get("C:\\ignite\\gmm.json");
                mdl.toJSON(jsonMdlPath); // TODO: write to the root in tmp directory

                GmmModel jsonMdl = new GmmModel().fromJSON(jsonMdlPath);
                ...
                for (int i = 0; i < jsonMdl.countOfComponents(); i++) {
                    MultivariateGaussianDistribution distribution = jsonMdl.distributions().get(i);
                    System.out.println();
                    System.out.println("============");
